...
- **A:** Scope dictates variable visibility (Lexical Environment), while Execution Context is the environment where the code evaluates (Call Stack, Memory Phase, `this` binding).
